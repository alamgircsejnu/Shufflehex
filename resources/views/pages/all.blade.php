...
@section('content')
    <div id="latest-list" class="col-md-7 col-sm-12">
        <div class="row">
            ...
            <div class="col-md-11 plr-1"><h3>All Stories</h3></div>
        </div>
<?php
...
//                    ---------------------------- Time conversion --------------------------------
                    ...
                    <div class="col-md-8 col-sm-7 plr-1">
                        ...
                        <h4 class="story-title"><a href="post/{{ $post->id }}/{{ $title }}" target="_blank"> {{ $post->title }}</a></h4>
                        ...
                        {{--<div class="addthis_inline_share_toolbox pull" data-url="http://localhost/shufflehex/public/post/{{ $post->id }}/{{ $title }}" data-title="{{ $post->title }}" data-description="{{ $post->description }}" data-media="{{ $post->link }}"></div>--}}
                        <div class="addthis_inline_share_toolbox pull-left"></div>
                        @if($savedStory == 1)
                        <div><a href="#" class="icon-share-circle" style="background-color: yellowgreen" id="btn_saveStory_{{ $post->id }}" onclick="saveStory({{ $post->id }})"><i class="fa fa-bookmark"></i></a></div>
                        @else
                            <div><a href="#" class="icon-share-circle" id="btn_saveStory_{{ $post->id }}" onclick="saveStory({{ $post->id }})"><i class="fa fa-bookmark"></i></a></div>
                        @endif
