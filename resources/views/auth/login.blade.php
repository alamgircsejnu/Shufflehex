    ...
    <div class="container col-md-7 col-sm-12">
        <div id="account-form">
            <form id="loginForm" method="POST" action="{{ route('login') }}" role="form">
                ...
                <div class="form-group">
                    <p style="color:#000;">Forgot Password - <a class="text-primary" href="#">Reset Now</a></p>
                    <p style="color: #0e5074">Don't have an account? - <a class="btn btn-xs" href="{{ url('pages/register') }}" style="background-color: #0e5074;color: #fff">Signup Now</a></p>
                </div>
            </form>
        </div>
    </div>
